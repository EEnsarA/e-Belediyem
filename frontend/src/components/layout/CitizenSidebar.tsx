...
import {
  ...
  Megaphone, User, Settings, LogOut, Sun, Moon, Bell, Globe
} from 'lucide-react'
        ...
        <div className="p-8">
          <Link href="/dashboard" className="flex items-center gap-3 group">
            ...
            <div className="flex flex-col">
              ...
              <div className="text-[10px] font-bold text-white/40 truncate max-w-[140px] mt-1">
                {user?.municipality_name || 'Vatandaş'}
              </div>
            </div>
          </Link>
        </div>
        ...
        <nav className="flex-1 px-4 py-8 space-y-1 overflow-y-auto">
          {citizenNav.map(({ href, icon: Icon, label }) => {
            ...
            return (
              ...
              >
                <Icon className={`w-4 h-4 shrink-0 ${isActive ? 'text-primary-900' : 'text-blue-300'}`} />
                {label}
              </Link>
            )
          })}
        ...
        <div className="p-4 space-y-2 border-t border-white/5">
          ...
          <div className="p-4 rounded-3xl bg-white/5 border border-white/10 flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-[10px] font-bold text-blue-300 uppercase tracking-tighter">VATANDAŞ</div>
            </div>
